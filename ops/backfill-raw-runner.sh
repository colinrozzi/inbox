...
#
# Run ONCE after the 0.24 cutover deploy. New mail already carries its real raw;
# this fills a reconstructed (lossy — original attachments/HTML gone; marked
# X-Inbox-Reconstructed: 1) raw for messages received before raw-retention.
#
# Requires: curl, jq.
